// Selectors
// Select the element with the class "theme-toggle" and store it in the themeToggleBtn variable
const themeToggleBtn = document.querySelector(".theme-toggle");
// Select the SVG elements by their IDs
const lightIcon = document.getElementById("light-icon");
const darkIcon = document.getElementById("dark-icon");

// State
// Check if a theme preference is stored in the local storage
const theme = localStorage.getItem("theme");

// on mount
// If a theme preference exists in local storage, add the "dark-mode" class to the body element
if (theme) {
...
// handlers
// Function to update the SVG content based on the current theme
function updateIcon(theme) {
  if (theme === "dark-mode") {
    // Update the SVG content for dark mode
    darkIcon.innerHTML = ` <p>Dark</p>
    ...
    `;
    lightIcon.innerHTML = ""; // Clear the light mode SVG content
  } else {
    // Update the SVG content for light mode
    lightIcon.innerHTML = ` <p>light</p>
  ...
  `;
    darkIcon.innerHTML = ""; // Clear the dark mode SVG content
  }
}

// events
// Adds a click event listener to the them toggle button
